 ...
 */
    ...
    public class Barcode2of5 extends Barcode1D
    {
        ...
        private static String[] encoding = new String[] { 'NNWWN', 'WNNNW', 'NWNNW', 'WWNNN', 'NNWNW', 'WNWNN', 'NWWNN', 'NNNWW', 'WNNWN', 'NWNWN' };
                ...
                if ( type.equals( 'int25' ) )
                {
                    ...
                    for ( int i = 0; i < end; i++ )
                    {
                        ...
                        for ( int j = 0; j < 5; j++ )
                        {
                            ...
                            if ( Barcode2of5.encoding[ c1 ].charAt( j ) == 'W' )
                            {
                                result.append( '1' );
                            }
                            ...
                            if ( Barcode2of5.encoding[ c2 ].charAt( j ) == 'W' )
                            {
                                result.append( '0' );
                            }
                        }
                ...
                else if ( type.equals( 'std25' ) )
                {
                    ...
                    for ( int i = 0; i < end; i++ )
                    {
                        ...
                        for ( int j = 0; j < 5; j++ )
                        {
                            ...
                            if ( Barcode2of5.encoding[ c ].charAt( j ) == 'W' )
                            {
                                result.append( '11' );
                            }
