            ...
            else
            {
                ...
                while( i < len )
                {
                    if ( ! tableCActivated )
                    {
                        ...
                        while ( ( i + j < len ) && ( '' + code.charAt( i + j ) ).matches( '[0-9]' ) )
                        {
                            j++;
                        }
                        ...
                        if ( tableCActivated )
                        {
                            ...
                            result.append( Barcode128.encoding[ 99 ] );
                    ...
                    else if ( ( i == len - 1 ) || ( '' + code.charAt( i ) ).matches( '[^0-9]' ) || ( '' + code.charAt( i + 1 ) ).matches( '[^0-9]' ) )
                    {
                        ...
                        result.append( Barcode128.encoding[ 100 ] );
